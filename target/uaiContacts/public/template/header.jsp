        ...
        <div class="navbar-inner">
            <div class="container">
                <ul class="nav" ng-controller="LocationController">
                    ...
                    <li ng-class="{'gray': activeURL == 'technology', '': activeURL != 'technology'}"><a title='<spring:message code="header.technology"/>' href="<c:url value='/protected/technology'/>"><p><spring:message code="header.technology"/></p></a></li>
                </ul>
