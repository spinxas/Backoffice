        ...
        <div id="gridContainer" ng-class="{'': state == 'list', 'none': state != 'list'}">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th scope="col"><spring:message code="contacts.surname"/></th>
                    <th scope="col"><spring:message code="contacts.status"/></th>
                    <th scope="col"><spring:message code="contacts.customer"/></th>
                    <th scope="col"><spring:message code="contacts.technology"/></th>
                ...
                <tr ng-repeat="contact in page.source">
                    ...
                    <td class="tdContactsCentered">{{contact.surname}}</td>
                    <td class="tdContactsCentered">{{contact.traineestatus.value}}</td>
                    <td class="tdContactsCentered">{{contact.customersID}}</td>
                    <td class="tdContactsCentered">{{contact.technologies.technology}}</td>
                    <td class="tdContactsCentered">{{contact.email}}</td>
                    <td class="tdContactsCentered">{{contact.phoneDetails}}</td>
                    <td class="width15">
