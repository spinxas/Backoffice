...
<div class="row-fluid" ng-controller="technologyController">
    <h2>
        <p class="text-center">
            <spring:message code='technology.header'/>
            <a href="#searchTechnologyModal"
               id="technologyHeaderButton"
               role="button"
               ng-class="{'': displaySearchButton == true, 'none': displaySearchButton == false}"
               title="<spring:message code="search"/>&nbsp;<spring:message code="technology"/>"
    ...
    <h4>
        <div ng-class="{'': state == 'list', 'none': state != 'list'}">
            <p class="text-center">
                <spring:message code="message.total.records.found"/>:&nbsp;{{page.totalTechnology}}
            </p>
        </div>
    </h4>
    ...
    <div>
        ...
        <div ng-class="{'alert alert-info': state == 'noresult', 'none': state != 'noresult'}">
            <h4><i class="icon-info-sign"></i> <spring:message code="technology.emptyData"/></h4><br/>

            <p><spring:message code="technology.emptyData.text"/></p>
        </div>
        ...
        <div id="gridContainer" ng-class="{'': state == 'list', 'none': state != 'list'}">
            <table class="table table-bordered table-striped">
                <thead>
                <tr>
                    <th scope="col"><spring:message code="technology.technology"/></th>
                    <th scope="col"><spring:message code="technology.version"/></th>
                    <th scope="col"><spring:message code="technology.description"/></th>
                    <th scope="col"><spring:message code="technology.coloursID"/></th>
                    <th scope="col"></th>
                </tr>
                </thead>
                <tbody>
                <tr ng-repeat="technology in page.source">
                    <td class="tdContactsCentered">{{technology.technology}}</td>
                    <td class="tdContactsCentered">{{technology.version}}</td>
                    <td class="tdContactsCentered">{{technology.description}}</td>
                    <td class="tdContactsCentered">{{technology.coloursID}}</td>
                    <td class="width15">
                        <div class="text-center">
                            <input type="hidden" value="{{technology.id}}"/>
                            <a href="#updateTechnologyModal"
                               ng-click="selectedTechnology(technology);"
                               role="button"
                               title="<spring:message code="update"/>&nbsp;<spring:message code="technology"/>"
                               class="btn btn-inverse" data-toggle="modal">
                                <i class="icon-pencil"></i>
                            </a>
                            <a href="#deleteTechnologyModal"
                               ng-click="selectedTechnology(technology);"
                               role="button"
                               title="<spring:message code="delete"/>&nbsp;<spring:message code="technology"/>"
                               class="btn btn-inverse" data-toggle="modal">
        ...
        <div ng-class="{'text-center': displayCreateTechnologyButton == true, 'none': displayCreateTechnologyButton == false}">
            <br/>
            <a href="#addTechnologyModal"
               role="button"
               ng-click="resetTechnology();"
               title="<spring:message code='create'/>&nbsp;<spring:message code='technology'/>"
               class="btn btn-inverse"
               data-toggle="modal">
                <i class="icon-plus"></i>
        ...
        <jsp:include page="dialogs/technologyDialogs.jsp"/>

    </div>
</div>

<script src="<c:url value="/resources/js/pages/technology.js" />"></script>