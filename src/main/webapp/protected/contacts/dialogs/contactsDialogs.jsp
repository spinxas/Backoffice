    ...
    <div class="modal-body">
        <form name="newContactForm" novalidate >
            <div class="pull-left align-right">
                ...
                <div>
                    <div class="input-append">
                        <label>* <spring:message code="contacts.surname"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="text"
                               required
                               ng-model="contact.surname"
                               name="surname"
                               placeholder="<spring:message code='contact'/>&nbsp;<spring:message code='contacts.surname'/> "/>
                    </div>
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && newContactForm.surname.$error.required">
                                    <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    <div class="input-append">
                        <label>* <spring:message code="contacts.status"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="text"
                               required
                               ng-model="contact.traineestatus.traineeStatusId"
                               name="traineestatus.traineeStatusId"
                               placeholder="<spring:message code='sample.status'/>"/>
                    </div>
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && newContactForm.traineestatus.traineeStatusId.$error.required">
                                        <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    <div class="input-append">
                        <label><spring:message code="contacts.customer"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="number"
                               ng-model="contact.customersID"
                               name="customersID"
                               placeholder="<spring:message code='sample.customer'/>"/>
                    </div>
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && newContactForm.customersID.$error.required">
                                        <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    <div class="input-append">
                        <label><spring:message code="contacts.technology"/>:</label>
                    </div>
                    <div class="input-append">
                        <input type="number"
                               ng-model="contact.groupsID"
                               name="groupsID"
                               placeholder="<spring:message code='sample.technology'/>"/>
                    </div>
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && newContactForm.groupsID.$error.required">
                                        <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    ...
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && newContactForm.phoneDetails.$error.required">
                                    <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
            ...
            <div class="pull-left align-right">
                ...
                <div>
                    ...
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && updateContactForm.surname.$error.required">
                                    <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    ...
                    <div class="input-append">
                        <input type="number"
                               required
                               ng-model="contact.traineestatus.id"
                ...
                <div>
                    ...
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && updateContactForm.customersID.$error.required">
                                    <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    ...
                    <div class="input-append">
                        <input type="number"
                               ng-model="contact.technologies.id"
                    ...
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && updateContactForm.technologies.id.$error.required">
                                    <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
                ...
                <div>
                    ...
                    <div class="input-append">
                        <label>
                                <span class="alert alert-error"
                                      ng-show="displayValidationError && updateContactForm.phoneDetails.$error.required">
                                    <spring:message code="required"/>
                                </span>
                        </label>
                    </div>
